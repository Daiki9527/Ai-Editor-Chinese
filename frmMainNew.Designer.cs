namespace AIEdit
{
	partial class frmMainNew
	{
		...
		private void InitializeComponent()
		{
			...
			this.aIGuideToolStripMenuItem.Text = "AI 向导";
			...
			this.olvColTFUnitCount.Text = "数量";
			// 
			// olvColTFName
			// 
			...
			this.mnuSTActionDelete.Text = "删除";
			...
			this.openFileDialog1.Filter = "Ini 文件 (*.ini)|*.ini";
			// 
			// saveFileDialog1
			// 
			this.saveFileDialog1.Filter = "Ini 文件 (*.ini)|*.ini";
			// 
			// frmMainNew
			// 
